...
class OrderPolicy
{
    ...
    {
        return $user->can('force_delete_post::order');
    }
    ...
    {
        return $user->can('force_delete_any_post::order');
    }
    ...
    {
        return $user->can('restore_post::order');
    }
    ...
    {
        return $user->can('restore_any_post::order');
    }
    ...
    {
        return $user->can('replicate_post::order');
    }
    ...
    {
        return $user->can('reorder_post::order');
    }
}
